...
# 迁移版本号 - 创建简化版ideas表
MIGRATION_VERSION = "v1.28_create_simple_ideas_fresh"
...
def run_migration():
    ...
    try:
        ...
        # ===========================================
        # 🔧 v1.28迁移任务：创建简化版ideas管理表（全新版本）
        # 用户需求：简化ideas管理，负责人改为文本输入 - 2025-07-25
        # ===========================================
        
        logger.info("🔧 开始v1.28迁移：创建简化版ideas管理表...")
        ...
        # 第三步：不迁移旧数据，创建全新的表
        logger.info("ℹ️ 此版本不迁移旧数据，创建全新的simple_ideas表")
        ...
        logger.info("=" * 70)
        logger.info("🎉 v1.28 简化版ideas管理表创建完成！")
